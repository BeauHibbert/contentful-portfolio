...
const SingleProjectPage = () => {
  ...
  //     await contentfulManagementClient.getSpace(process.env.REACT_APP_CONTENTFUL_SPACEID)
  //     .then(space => space.getEnvironment(process.env.REACT_APP_CONTENTFUL_ENVIRONMENTID))
