// The "contentful" package is a JS library that allows interaction with Contentful's Content Delivery API (CDA) and Content Preview API (CPA). It does NOT allow interaction with the Content Management API (CMA).
